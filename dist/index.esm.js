...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#fdfafa", backgroundDisabled: "#f7e7e6", contrast: "#261c13", invertedContrast: "#FFFFFF", input: "#fffaf7", tertiary: "#EFF4F5", text: "#452c21", textDisabled: "#d6cfcc", textSubtle: "#452c21", borderColor: "#ebeae9", card: "#FFFFFF", gradients: {
